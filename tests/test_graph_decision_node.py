...
def test_graph_decision_node_malformed_output_falls_back_to_respond(monkeypatch) -> None:
    ...
    result = decision_node({"agent_key": "generic_assistant", "user_input": "create csv"})
...
def test_graph_decision_node_prefixed_json_still_responds(monkeypatch) -> None:
    ...
    result = decision_node({"agent_key": "generic_assistant", "user_input": "hello"})
...
def test_graph_decision_node_rejects_use_tool_when_required_input_missing(monkeypatch) -> None:
    ...
    result = decision_node({"agent_key": "generic_assistant", "user_input": "summarize this page for me"})
...
def test_graph_decision_node_writes_active_tool_call_when_phase_is_source(monkeypatch) -> None:
    ...
    result = decision_node({"agent_key": "generic_assistant", "user_input": "latest llm", "phase": "source"})
...
def test_graph_decision_node_writes_active_tool_call_when_phase_is_artifact(monkeypatch) -> None:
    ...
    result = decision_node({"agent_key": "generic_assistant", "user_input": "create a resume document", "phase": "artifact"})
...
def test_graph_decision_node_writes_active_tool_call_for_artifact_intent(monkeypatch) -> None:
    _patch(
        monkeypatch,
        tools=["create_word_document"],
...
def test_graph_decision_node_omits_disallowed_keys_for_respond_action(monkeypatch) -> None:
    _patch(
        monkeypatch,
        tools=[],
...
def test_graph_decision_node_omits_disallowed_keys_for_source_tool_intent(monkeypatch) -> None:
    _patch(
        monkeypatch,
        tools=["search_web"],
    ...
    result = decision_node({"agent_key": "generic_assistant", "user_input": "x"})
...
def test_graph_decision_node_filters_tool_call_history_to_current_task(monkeypatch) -> None:
