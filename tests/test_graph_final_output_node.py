...
@pytest.mark.asyncio
async def test_final_output_writes_only_final_response_from_synthesis_draft() -> None:
    result = await final_output_node(
        {
...
@pytest.mark.asyncio
async def test_final_output_ignores_legacy_draft_output_and_uses_fallback() -> None:
    result = await final_output_node(
        {
...
@pytest.mark.asyncio
async def test_final_output_uses_fallback_when_no_response_available() -> None:
    result = await final_output_node({})
...
@pytest.mark.asyncio
async def test_final_output_prefers_synthesis_draft_over_draft_output() -> None:
    result = await final_output_node(
        {
...
@pytest.mark.asyncio
async def test_final_output_uses_fallback_on_execution_failure() -> None:
    result = await final_output_node(
        {
